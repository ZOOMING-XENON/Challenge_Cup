...
def watchdog(collected_data,wechat_dir,download_dir,server_url):
    # 监控文件系统变化的类
    ...
    def main():
        ...
        # 下载目录
        pull_dir = os.path.join(os.path.expanduser('~'), 'Downloads', 'SecuritySystem')
        #生成了下载目录～\Downloads\SecuritySystem

        print(f"开始监控...")
        print(f"文件将下载到: {pull_dir}")
        print("按 Ctrl+C 停止监控")
        ...
        while True:
            try:
                ...
                data = {
                    ...
                    "wechat_files": collected_data["wechat_files"],#这个是触发了才有
